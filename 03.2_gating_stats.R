...
# # you can also load a gating set from a flowjo workspace file
# # load workspace file
# ws <- CytoML::open_flowjo_xml(workspace_file)
# # load fcs files associated with the workspace file
# gs <- CytoML::flowjo_to_gatingset(ws, name="group_name", path=fcs_files_dir)
